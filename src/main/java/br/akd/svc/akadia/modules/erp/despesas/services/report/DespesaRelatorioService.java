...
public class DespesaRelatorioService {
    ...
    public void exportarPdf(ColaboradorId idColaboradorSessao, HttpServletResponse response,
                            List<UUID> idsdespesas)
        ...
        try (Document document = new Document(PageSize.A4)) {
            ...
            document.add(constroiParagrafoDataHora(colaboradorLogado));
