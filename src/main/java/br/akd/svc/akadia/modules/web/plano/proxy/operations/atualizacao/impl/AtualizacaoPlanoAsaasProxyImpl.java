...
public class AtualizacaoPlanoAsaasProxyImpl {
    ...
    public void realizaAtualizacaoDePlanoDeAssinaturaNaIntegradoraAsaas(PlanoEntity planoAtualizado) {
        ...
        AtualizaAssinaturaAsaasRequest atualizaAssinaturaAsaasRequest = AtualizaAssinaturaAsaasRequest.builder()
                .billingType(planoAtualizado.getFormaPagamentoSistemaEnum())
                .value(planoAtualizado.getTipoPlanoEnum().getValor())
                .nextDueDate(planoAtualizado.getDataVencimento())
                .discount(null)
                .interest(null)
                .fine(null)
                .cycle(CycleEnum.MONTHLY)
                .description(planoAtualizado.getTipoPlanoEnum().getDesc())
