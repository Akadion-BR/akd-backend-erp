package br.akd.svc.akadia.modules.erp.colaboradores.colaborador.services.report;
...
public class ColaboradorRelatorioService {
    ...
    public void exportarPdf(ColaboradorId idColaboradorLogado,
        ...
        ColaboradorEntity usuarioLogado = securityUtil.obtemUsuarioSessao(idColaboradorLogado);
        ...
        try (Document document = new Document(PageSize.A4)) {
            ...
            acaoService.salvaHistoricoColaborador(idColaboradorLogado, null,
    ...
    private void escreveDadosTabela(PdfPTable table, java.util.List<ColaboradorEntity> colaboradores) {
        ...
        for (ColaboradorEntity colaborador : colaboradores) {
            ...
            String telefone = colaborador.getTelefone() == null
                    ? "Sem telefone"
                    : colaborador.getTelefone().obtemTelefoneCompleto();
            cell.setPhrase(new Phrase(telefone, font));
            table.addCell(cell);

            String cpfCnpj = colaborador.getCpfCnpj() == null
                    ? "Sem Cpf/Cnpj"
                    : colaborador.getCpfCnpj();
