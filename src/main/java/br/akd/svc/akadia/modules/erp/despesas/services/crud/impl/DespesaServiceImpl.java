...
public class DespesaServiceImpl implements DespesaService {
    ...
    public DespesaPageResponse realizaBuscaPaginadaPorDespesas(ColaboradorId idColaboradorSessao,
        ...
        Page<DespesaEntity> despesaPage = campoBusca != null && !campoBusca.isEmpty()
                ? despesaRepository
                .buscaPorDespesasTypeAhead(pageable, idColaboradorSessao.getIdEmpresa(), dataInicio, dataFim, campoBusca)
                : despesaRepository
                .buscaPorDespesas(pageable, idColaboradorSessao.getIdEmpresa(), dataInicio, dataFim);
    ...
    public DespesaResponse realizaBuscaDeDespesaPorId(ColaboradorId idColaboradorSessao,
        ...
        DespesaEntity despesa = despesaRepositoryImpl
                .implementaBuscaPorId(idColaboradorSessao.getIdEmpresa(), idDespesa);
    ...
    public void removeDespesasEmMassa(ColaboradorId idColaboradorSessao,
        ...
        List<DespesaEntity> despesasEncontradas = despesaRepositoryImpl.implementaBuscaPorIdEmMassa(
                new EmpresaId(idColaboradorSessao.getIdClienteSistema(), idColaboradorSessao.getIdEmpresa()), ids);
